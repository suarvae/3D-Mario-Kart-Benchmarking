...
public class OutOfBounds : MonoBehaviour
{
    ...
    { 
        if(other.gameObject.tag == "OutOfBounds" )
        {
            ...
            GameObject lakitu = Instantiate(fetcher, transform.position + Vector3.up * 3, fetcher.transform.rotation);
            lakitu.transform.position = transform.position + Vector3.up * 3;
            yield return new WaitForSeconds(.15f);
            Transform currPoint = GetComponent<LapCounter>().checkpoints.GetChild(GetComponent<LapCounter>().currentCheckpointVal - 1);
            ...
            yield return null; //Add this myself, doesnt make sense to keep other conditions in when this happens. 
        }
