...
[Serializable]
class UnakinMarkerData : IComparable<UnakinMarkerData>
{
    public string name;
    public int nameLowerCaseHash;   // lower case name hash for faster comparisons
    
    public UnakinMarkerData parent;
    public List<UnakinMarkerData> children = new List<UnakinMarkerData>();
    ...
    public List<UnakinFrameTime> frames;

    public double timeRemoved;
    public double timeIgnored;

    public UnakinMarkerData(string markerName)
    {
        buckets = new int[bucketCount];
        countBuckets = new int[bucketCount];
        frames = new List<UnakinFrameTime>();
    ...
    /// <param name="other"> The other UnakinMarkerData to compare </param>
    /// <returns>-1 if this is larger, 0 if the same, 1 if this is smaller</returns>
    public int CompareTo(UnakinMarkerData other)
    {
    ...
    public static string GetFirstThread(UnakinMarkerData marker)
    {
        return marker != null ? marker.threads[0] : "";
    }

    public static float GetMsMax(UnakinMarkerData marker)
    {
        return marker != null ? marker.msMax : 0.0f;
    }

    public static int GetMaxFrameIndex(UnakinMarkerData marker)
    {
        return marker != null ? marker.maxFrameIndex : 0;
    }

    public static float GetMsMin(UnakinMarkerData marker)
    {
        return marker != null ? marker.msMin : 0.0f;
    }

    public static int GetMinFrameIndex(UnakinMarkerData marker)
    {
        return marker != null ? marker.minFrameIndex : 0;
    }

    public static float GetMsMedian(UnakinMarkerData marker)
    {
        return marker != null ? marker.msMedian : 0.0f;
    }

    public static int GetMedianFrameIndex(UnakinMarkerData marker)
    {
        return marker != null ? marker.medianFrameIndex : 0;
    }

    public static float GetMsUpperQuartile(UnakinMarkerData marker)
    {
        return marker != null ? marker.msUpperQuartile : 0.0f;
    }

    public static float GetMsLowerQuartile(UnakinMarkerData marker)
    {
        return marker != null ? marker.msLowerQuartile : 0.0f;
    }

    public static float GetMsMean(UnakinMarkerData marker)
    {
        return marker != null ? marker.msMean : 0.0f;
    }

    public static float GetMsMinIndividual(UnakinMarkerData marker)
    {
        return marker != null ? marker.msMinIndividual : 0.0f;
    }

    public static float GetMsMaxIndividual(UnakinMarkerData marker)
    {
        return marker != null ? marker.msMaxIndividual : 0.0f;
    }

    public static int GetPresentOnFrameCount(UnakinMarkerData marker)
    {
        return marker != null ? marker.presentOnFrameCount : 0;
    }

    public static float GetMsAtMedian(UnakinMarkerData marker)
    {
        return marker != null ? marker.msAtMedian : 0.0f;
    }

    public static int GetCountMin(UnakinMarkerData marker)
    {
        return marker != null ? marker.countMin : 0;
    }

    public static int GetCountMax(UnakinMarkerData marker)
    {
        return marker != null ? marker.countMax : 0;
    }

    public static int GetCount(UnakinMarkerData marker)
    {
        return marker != null ? marker.count : 0;
    }

    public static float GetCountMean(UnakinMarkerData marker)
    {
        return marker != null ? marker.countMean : 0.0f;
    }

    public static double GetMsTotal(UnakinMarkerData marker)
    {
        return marker != null ? marker.msTotal : 0.0;
    }

    public static int GetMinDepth(UnakinMarkerData marker)
    {
        return marker != null ? marker.minDepth : 0;
    }

    public static int GetMaxDepth(UnakinMarkerData marker)
    {
        return marker != null ? marker.maxDepth : 0;
    }
    public static double GetTimeRemoved(UnakinMarkerData marker)
    {
        return marker != null ? marker.timeRemoved : 0.0;
    }
    public static double GetTimeIgnored(UnakinMarkerData marker)
    {
