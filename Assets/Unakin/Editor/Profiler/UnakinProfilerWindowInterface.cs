...
namespace Unakin
{
    internal class ProfilerWindowInterface
    {
        ...
        public UnakinProfileData PullFromProfiler(int firstFrameDisplayIndex, int lastFrameDisplayIndex, string pdata_path)
        {
            ...
            UnakinProfileData profileData = GetData(firstFrameIndex, lastFrameIndex, pdata_path);
        ...
        UnakinProfileData GetDataRaw(UnakinProfileData data, int firstFrameIndex, int lastFrameIndex)
        {
            ...
            for (int frameIndex = firstFrameIndex; frameIndex <= lastFrameIndex; ++frameIndex)
            {
                ...
                while (true)
                {
                    ...
                    {                                                
                        ...
                        threadNameWithIndex = UnakinProfileData.ThreadNameWithIndex(threadNameCount[threadName], threadName);
        ...
        UnakinProfileData GetDataOriginal(UnakinProfileData data, int firstFrameIndex, int lastFrameIndex)
        {
            ProfilerFrameDataIterator frameData = new ProfilerFrameDataIterator();
            bool firstError = true;
            ...
            for (int frameIndex = firstFrameIndex; frameIndex <= lastFrameIndex; ++frameIndex)
            {
                ...
                */
                ...
                for (int threadIndex = 0; threadIndex < threadCount; ++threadIndex)
                {
                    ...
                    data.AddThreadName(UnakinProfileData.ThreadNameWithIndex(threadNameCount[threadName], threadName), thread);
        ...
        UnakinProfileData GetData(int firstFrameIndex, int lastFrameIndex, string pdata_path)
        {
            UnakinProfileData data = new UnakinProfileData(pdata_path);
        ...
        IEnumerator<ThreadIndexIterator> GetNextThreadIndexFittingThreadFilters(int frameIndex, List<string> threadFilters)
        {
            ...
            for (int threadIndex = 0; threadIndex < threadCount; ++threadIndex)
            {
                ...
                var threadNameWithIndex = UnakinProfileData.ThreadNameWithIndex(threadNameCount[threadName], threadName);
