...
struct UnakinThreadIdentifier
{
    ...
    /// <summary>Initialise UnakinThreadIdentifier</summary>
    /// <param name="name">The thread name</param>
    /// <param name="index">The thread index</param>
    public UnakinThreadIdentifier(string name, int index)
    {
        this.name = name;
        this.index = index;
        if (index == kAll)
    ...
    public UnakinThreadIdentifier(UnakinThreadIdentifier threadIdentifier)
    {
    ...
    public UnakinThreadIdentifier(string threadNameWithIndex)
    {
